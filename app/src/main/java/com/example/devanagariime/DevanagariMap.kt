...
object DevanagariMap {
    ...
    val table: Map<Int, Array<String>> = mapOf(
        KeyEvent.KEYCODE_A to arrayOf("ा", "आ", "", ""),
        KeyEvent.KEYCODE_B to arrayOf("ब", "भ", "", ""),
        KeyEvent.KEYCODE_C to arrayOf("च", "छ", "", ""),
        KeyEvent.KEYCODE_D to arrayOf("द", "ध", "ऽ", ""),
        ...
        KeyEvent.KEYCODE_K to arrayOf("क", "ख", "ॢ", "ॣ"),
        KeyEvent.KEYCODE_L to arrayOf("ल", "ञ", "ऌ", "ॡ"),
        KeyEvent.KEYCODE_M to arrayOf("म", "ं", "॰", ""),
        KeyEvent.KEYCODE_N to arrayOf("न", "ण", "", ""),
        KeyEvent.KEYCODE_O to arrayOf("ो", "ौ", "ॐ", ""),
        ...
        KeyEvent.KEYCODE_Z to arrayOf("अ", "त्र", "", ""),

        KeyEvent.KEYCODE_LEFT_BRACKET  to arrayOf("इ", "ई", "[", "{"),
        KeyEvent.KEYCODE_RIGHT_BRACKET to arrayOf("ओ", "औ", "]", "}"),
        KeyEvent.KEYCODE_SEMICOLON     to arrayOf("्", "ए", ";", ":"),
        KeyEvent.KEYCODE_APOSTROPHE    to arrayOf("'", "\"", "", ""),
        KeyEvent.KEYCODE_COMMA         to arrayOf(",", "उ", "॥", "<"),
        KeyEvent.KEYCODE_PERIOD        to arrayOf("।", "ऊ", ".", ">"),
        KeyEvent.KEYCODE_SLASH         to arrayOf("ऐ", "?", "/", ""),
